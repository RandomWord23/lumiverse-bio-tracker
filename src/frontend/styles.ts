...
export const bioTrackerStylesheet = `
    ...
    .bt-tab-btn { flex: 0 1 auto; min-width: 0; padding: 12px 8px; background: transparent; color: #888; border: none; font-weight: bold; cursor: pointer; text-align: center; font-size: 12px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    .bt-tab-btn[data-tab="tab-dice"], .bt-tab-btn[data-tab="tab-settings"] { flex: 0 0 auto; padding: 12px 10px; font-size: 15px; }
