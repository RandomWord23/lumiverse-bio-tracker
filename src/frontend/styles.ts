...
export const bioTrackerStylesheet = `
    ...
    .bt-tab-btn { flex: 0 1 auto; padding: 12px 10px; background: transparent; color: #888; border: none; font-weight: bold; cursor: pointer; text-align: center; font-size: 13px; white-space: nowrap; }
